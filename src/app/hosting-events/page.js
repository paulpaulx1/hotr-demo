  ...
  return (
    <main className='bg-white text-slate-800'>
      ...
      <section className='relative h-[400px] md:h-[750px] flex items-center justify-center overflow-hidden bg-slate-900 text-white'>
        ...
        <div className='relative z-10 max-w-3xl px-6 text-center opacity-0 translate-y-4 animate-[fadeInUp_1.8s_ease-out_forwards]'>
          ...
          <p className='text-lg md:text-xl font-light text-white/90'>
            A serene setting for weddings, retreats, concerts, and gatherings —
            a place apart in the heart of New York.
          </p>
        </div>
      </section>
      ...
      <section className='max-w-4xl mx-auto px-6 py-16 leading-relaxed text-slate-700'>
        <p className='mb-4'>
          The House lends itself well to retreats for all faiths, meetings,
          concerts, private parties, wedding receptions, and non-profit or
          corporate events. Its Italian Renaissance interior is a unique setting
          of elegance and charm.
        </p>
        <p className='mb-4'>
          The <strong>Reception Room</strong> is ideal for smaller meetings and
          parties; the <strong>Refectory</strong> is perfect for lunches,
          dinners, and distinguished events; and the <strong>Library</strong>{' '}
          offers fine acoustics and historic atmosphere for lectures, weddings,
        ...
        <p className='mb-6'>
          ...
          for availability and rates. Reduced rates are available for churches
