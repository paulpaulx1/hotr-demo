      ...
      <div className="bg-slate-50 py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
            <div className="mb-8">
              <h2 className="font-serif text-3xl font-medium text-slate-900 mb-3">
                Contact Us
              </h2>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow p-6 text-center">
              ...
              <a href="tel:+12122890399" className="text-slate-600 hover:text-slate-900">
                (212) 289-0399
              </a>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 text-center">
              ...
              <a href="mailto:info@houseoftheredeemer.org" className="text-slate-600 hover:text-slate-900">
