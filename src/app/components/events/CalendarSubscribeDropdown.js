      ...
      {isOpen && (
        <div className="absolute right-0 mt-1 w-64 bg-white border border-gray-200 shadow-lg rounded-md z-10">
          <ul className="py-1">
            <li>
              <a
                href={`https://calendar.google.com/calendar/render?cid=${encodeURIComponent(`${window.location.origin}${calendarFeedUrl}`)}`}
                target="_blank"
            ...
            <li>
              <a
                href={`webcal://${window.location.host}${calendarFeedUrl}`}
                className="block px-4 py-2 hover:bg-gray-100 text-gray-800"
              >
                iCalendar
              </a>
            ...
            <li>
              <a
                href={`https://outlook.office.com/calendar/addcalendar?url=${encodeURIComponent(`${window.location.origin}${calendarFeedUrl}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="block px-4 py-2 hover:bg-gray-100 text-gray-800"
              >
            ...
            <li>
              <a
                href={`https://outlook.live.com/calendar/0/addfromweb?url=${encodeURIComponent(`${window.location.origin}${calendarFeedUrl}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="block px-4 py-2 hover:bg-gray-100 text-gray-800"
              >
