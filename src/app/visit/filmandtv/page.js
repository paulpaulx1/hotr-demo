  ...
  return (
    <main className={styles.wrapper}>
      ...
      <div className={styles.grid}>
        <section className={`${styles.card} ${styles.noImage}`}>
          <div className={styles.text}>
            ...
            <p className={styles.description}>
              ...
              projects. Located just off Fifth Avenue and within walking
              distance of Central Park, the House offers a quiet, private
              setting with multiple interior spaces and an enclosed courtyard.
        ...
        <section
          className={`${styles.card} ${styles.noImage} ${styles.creamBg}`}
        >
          <div className={styles.text}>
            ...
            <ul className={styles.spaceList}>
              <li>
                <strong>Library</strong> – A two-story, wood-paneled library
                with a piano and historic European character
              </li>
              <li>
                <strong>Refectory</strong> – A large room suitable for wider
                shots or group scenes
              </li>
              <li>
        ...
        >
          <div className={styles.text}>
            ...
            <p className={styles.description}>
              Constructed between 1914 and 1916 as a private residence, the
              House of the Redeemer was commissioned by Edith Shepard Fabbri, a
              great-granddaughter of Commodore Vanderbilt, and her husband
              Ernesto Fabbri. The building was designated a New York City
              landmark in 1974.
            </p>
