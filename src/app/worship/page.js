...
export default function WorshipPage() {
  return (
    <main className="bg-slate-50 text-slate-800">
      {/* ---------- Hero Section ---------- */}
      <section className="relative h-[400px] md:h-[750px] bg-slate-900 overflow-hidden flex items-center justify-center pt-24">
        {/* Background image fades in */}
        <div
          className="absolute inset-0 bg-cover bg-center opacity-0 animate-[fadeInBg_1.2s_ease-out_forwards]"
          style={{
            backgroundImage: `url('/images/house-of-the-redeemer_chapel2.jpg')`,
          }}
        />
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              ...
              Edith Fabbri’s Drawing Room, which retains its Renaissance ceiling
              and 18th-century altar. The chapel is open for prayer and
